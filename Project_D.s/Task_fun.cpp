...
bool Task_fun::validDate(string &date) {
	...
	int_only.erase(2, 1);
	int_only.erase(4, 1);
	/*if (!number_only(int_only))return false;*/
	date[2] = date[5] = '-';
...
void Task_fun::menu()
{
	...
	cout << "\t\t\t\t\t" << "To Add New Task Enter 1 " << endl << endl;
	cout << "\t\t\t\t\t" << "To Delete Task Enter 2 " << endl << endl;
	cout << "\t\t\t\t\t" << "To Update Task data Enter 3" << endl << endl;
	cout << "\t\t\t\t\t" << "To Submit A Task as Finished Enter 4 " << endl << endl;
	cout << "\t\t\t\t\t" << "To Display The Tasks Enter 5 " << endl << endl;
	cout << "\t\t\t\t\t" << "To Search About Task Enter 6 " << endl << endl;
}
